...
SELECT pp.resourceID, pp.title, pp.description, l.legislativeStatus AS 'Status da legislação', t.TYPE AS tipo, i.institution AS instituicao, pp.bibliographicCitation, pp.references_url FROM public_policies pp
